...
*/}}
{{- define "inscripciones-service.chart" -}}
...
helm.sh/chart: {{ include "inscripciones-service.chart" . }}
...
*/}}
{{- define "inscripciones-service.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "inscripciones-service.fullname" .) .Values.serviceAccount.name }}
{{- else }}
